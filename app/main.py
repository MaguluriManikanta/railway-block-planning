...
— Ministry of Railways &nbsp;|&nbsp; Intelligent Block &amp; Disconnection Management System (BDMS)
    ...
    with col_l2:
        ...
        st.markdown("""
        <div style="background: transparent; border: 1px solid rgba(234, 179, 8, 0.4); border-radius: 8px; padding: 12px 14px; margin-top: 14px; margin-bottom: 10px; color: #facc15; font-size: 0.88rem; line-height: 1.45; font-weight: 600;">
